...
describe('Service Tests', () => {
    ...
    describe('BildMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BildMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/bilds';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BildMySuffix', () => {

                let entity: BildMySuffix;
                service.find(123).subscribe((_entity: BildMySuffix) => {
                    entity = _entity;
                });
