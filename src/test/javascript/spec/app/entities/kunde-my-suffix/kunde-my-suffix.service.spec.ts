...
describe('Service Tests', () => {
    ...
    describe('KundeMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(KundeMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/kundes';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return KundeMySuffix', () => {

                let entity: KundeMySuffix;
                service.find(123).subscribe((_entity: KundeMySuffix) => {
                    entity = _entity;
                });
