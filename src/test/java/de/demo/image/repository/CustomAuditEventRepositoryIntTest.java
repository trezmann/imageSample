...
import de.demo.image.config.audit.AuditEventConverter;
import de.demo.image.domain.PersistentAuditEvent;
...
import static de.demo.image.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
